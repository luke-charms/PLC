...
eval1 ((TmBlank n1),env1,(HCombine e2 e3 e4 env2):k) = (e2,env2,(HHCombine (TmTile n1 (makeBlank n1)) e3 e4 env1) : k)
eval1 ((TmTile n1 tile1),env1,(HCombine e2 e3 e4 env2):k) = (e2,env2,(HHCombine (TmTile n1 tile1) e3 e4 env1) : k)
eval1 ((TmBlank n2),env1,(HHCombine e1 e3 e4 env2):k) = (e3,env2,(HHHCombine e1 (TmTile n2 (makeBlank n2)) e4 env1) : k)
eval1 ((TmTile n2 tile2),env1,(HHCombine e1 e3 e4 env2):k) = (e3,env2,(HHHCombine e1 (TmTile n2 tile2) e4 env1) : k)
eval1 ((TmBlank n3),env1,(HHHCombine e1 e2 e4 env2):k) = (e4,env2,(CombineH e1 e2 (TmTile n3 (makeBlank n3))) : k)
eval1 ((TmTile n3 tile3),env1,(HHHCombine e1 e2 e4 env2):k) = (e4,env2,(CombineH e1 e2 (TmTile n3 tile3)) : k)
eval1 ((TmBlank n4),env,(CombineH (TmTile n1 tile1) (TmTile n2 tile2) (TmTile n3 tile3)):k) = ((TmTile n4 (makeBlank n4)),env,(CombineH (TmTile n1 tile1) (TmTile n2 tile2) (TmTile n3 tile3)):k)
...
eval1 ((TmTile (TmInt n) tile2),env,(ReplaceH (TmInt x) (TmInt y) (TmTile (TmInt m) tile1)):k) = (TmTile (TmInt n) (tileReplace x y m tile1 n tile2),[],k)
